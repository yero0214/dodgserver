...
const riotKey = "RGAPI-7d085c59-5308-45d9-876b-48aff5035ad2";
...
app.get("/", async (req, res) => {
    ...
    async function getMatches(puuid){
      ...
      //   console.log(matches.data[i]);
      //   matchesWaiting = await axios.get("https://asia.api.riotgames.com/lol/match/v5/matches/" + encodeURI(matches.data[i]), {
      //     headers: {"X-Riot-Token": riotKey},
      //   })
      //   matchesResult[i] = matchesWaiting.data;
      // }
      // return matchesResult;
    };
